...
namespace CheeseCaveDotnet
{
    class Device
    {
        ...
        private static stateEnum fanState = stateEnum.off;                      

        // The device connection string to authenticate the device with your IoT hub.
        private readonly static string s_deviceConnectionString = "YOUR DEVICE CONNECTION STRING HERE";
        ...
        private static Task<MethodResponse> SetFanState(MethodRequest methodRequest, object userContext)
        {
            ...
            else
            {
                try
                {
                    ...
                    // Control the "fan" (LED)
                    s_gpio.Write(s_pin, fanState == stateEnum.on ? PinValue.High : PinValue.Low);
