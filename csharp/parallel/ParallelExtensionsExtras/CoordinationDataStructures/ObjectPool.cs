...
namespace System.Collections.Concurrent
{
    ...
    public sealed class ObjectPool<T> : ProducerConsumerCollectionBase<T>
    {
        ...
        public ObjectPool(Func<T> generator, IProducerConsumerCollection<T> collection)
            : base(collection) => _generator = generator ?? throw new ArgumentNullException("generator");
        ...
        public T GetObject() => base.TryTake(out T value) ? value : _generator();
        ...
        public T[] ToArrayAndClear()
        {
            ...
            while (base.TryTake(out T value)) items.Add(value);
