...
### Running the project
Once the solution has been successfully built, all you need to do is run the `SharedC` project.  A console will pop up and output the results of executing the imported Go functions.  These can be seen in `Program.cs`.
