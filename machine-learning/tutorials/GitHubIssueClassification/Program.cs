...
namespace GitHubIssueClassification
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            _trainingDataView = _mlContext.Data.CreateTextLoader<GitHubIssue>(hasHeader: true).Load(_trainDataPath);
            // </SnippetLoadTrainData>
        ...
        public static void Evaluate()
        {
            ...
            var testDataView = _mlContext.Data.CreateTextLoader<GitHubIssue>(hasHeader: true).Load(_testDataPath);
            // </SnippetLoadTestDataset>
