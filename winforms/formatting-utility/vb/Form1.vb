...
Public Class Form1
   ...
   Private rm As New ResourceManager("Formatter.Resources", Me.GetType().Assembly)
   ...
   Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      ...
      Me.ValueLabel.Text = rm.GetString("ValueLabel")
      Me.FormatLabel.Text = rm.GetString("FormatLabel")
      Me.ResultLabel.Text = rm.GetString("ResultLabel")
