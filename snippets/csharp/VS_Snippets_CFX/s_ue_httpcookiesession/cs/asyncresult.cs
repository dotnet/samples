...
namespace Microsoft.ServiceModel.Samples
{
    ...
    abstract class AsyncResult : IAsyncResult
    {
        ...
        // of the operation and notifies the callback.
        protected void Complete(bool completedSynchronously)
        {
            ...
            // If the callback throws an exception, there is a bug in the callback implementation.
            if (callback != null)
            {
                callback(this);
            }
        ...
        // the callback, it captures the exception and stores it to be thrown during AsyncResult.End.
