...
//</snippet1>
        ...
        #region Unused_teststuff Won't appear in snippet

        //class EndlessData : IEnumerable<ChunkIt.KeyValPair>
        //{
        //    static string[] keys = new[] { "A", "B", "C", "D", "E" };
        //    public IEnumerator<ChunkIt.KeyValPair> GetEnumerator()
        //    {
        //        string s = DateTime.Now.ToString();
        //        string s2 = s + new String('Q', 1024); //use up memory faster
        //        for (; ; )
        //        {
        //            Random rand = new System.Random();
        //            int i = rand.Next(5);

        //            yield return new ChunkIt.KeyValPair() { Key = keys[i], Value = s };
        //        }
        //    }
        ...
        //}
            ...
            //    System.Threading.Thread worker = new System.Threading.Thread(WorkerThread);
            //worker.Start();
            
           
            //// was used in main program class for testing thread safety
            //static void WorkerThread()
            //{

            //    foreach (var item in query)
            //    {
            //        //Console.WriteLine("worker thread Group key = {0}", item.Key);
            //        foreach (var inner in item)
            //        {
            //            Console.WriteLine("\tworker {0} {1}", inner.Key, inner.Value);
