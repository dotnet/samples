...
/* The following example demonstrates the events 
   'MappingNameChanged', 'GridLineStyleChanged' of class 'DataGridTableStyle'.
   The following program creates a Windows form, a DataSet containing two DataTable objects,
   and a DataRelation that relates the two tables. A button on the form changes data and 
   appearance of the grid by setting the MappingName and GridLineStyle.
*/
