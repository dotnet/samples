    ...
    public class Test
    {
       ...
       static void DisplayPendingByteCount(Socket s)
        ...
        public static void Main()
        {
            ...
            IPEndPoint endPoint = new IPEndPoint(localHost.AddressList[0], 11000);
            ...
            s.Listen(1);
            Console.WriteLine ("Waiting to receive messages from client...");
            ...
            while (true)
            {
                ...
                Console.WriteLine(" Server received the following message : {0}",
                    message);
