...
public:
    ...
    )
    {
        ...
        if (NULL != pScriptMapInfo)
        {
            ...
            // Retrieve the name.
            pwszName = pScriptMapInfo->GetName();
            ...
            if (NULL != pwszName)
            {
                ...
                if (cchName>0)
                {
                    ...
                    wcstombs(pszName,pwszName,cchName);
                }

                // Return the name information to the client.
                WriteResponseMessage(pHttpContext,"Name: ",
                    (cchName>0) ? pszName : "n/a");
