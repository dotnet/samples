...
public:
    ...
    )
    {
        ...
        try
        {
            ...
            // Write the IHttpTraceContext pointer
...
protected:
    ...
    // The Write method writes IHttpTraceContext 
    ...
    ) throw (CEventException)
    {
        ...
        // identifier to a wstring.
        wstring activityId = 
            CConvert::ToString(activityIdLPCGUID);

        // Write the activity identifier 
        // to the event log.
        ReportInfo(L"IHttpTraceContext::GetTraceActivityId",
                   activityId);
    }
private:
