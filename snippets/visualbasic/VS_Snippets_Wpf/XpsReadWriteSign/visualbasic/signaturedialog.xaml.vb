...
Namespace SDKSample
	...
	Partial Public Class SignatureDialog
		...
		Public Function AddSignatureItem(signatureDefintion As XpsSignatureDefinition) As SignatureDisplayItem
		...
		Private Sub SignCommandHandler(sender As Object, e As RoutedEventArgs)
        ...
        Private Sub DoneCommandHandler(sender As Object, e As RoutedEventArgs)
            Close()
        End Sub
...
#Region "Private Members"
        Private ReadOnly _signatureUtilities As SignatureUtilites
...
#Region "Constructor"
        Public Sub New()
            ...
            _requestBlock = New TextBlock With {
                .Width = 100
            }
            Me.Children.Add(_requestBlock)

            _signerBlock = New TextBlock With {
                .Width = 100
            }
            Me.Children.Add(_signerBlock)

            _intentBlock = New TextBlock With {
                .Width = 100
            }
            Me.Children.Add(_intentBlock)

            _locationBlock = New TextBlock With {
                .Width = 100
            }
            Me.Children.Add(_locationBlock)

            _signByBlock = New TextBlock With {
                .Width = 50
            }
...
#Region "Private Members"
        ...
        Private ReadOnly _requestBlock As TextBlock
        Private ReadOnly _signerBlock As TextBlock
        Private ReadOnly _intentBlock As TextBlock
        Private ReadOnly _locationBlock As TextBlock
        Private ReadOnly _signByBlock As TextBlock
