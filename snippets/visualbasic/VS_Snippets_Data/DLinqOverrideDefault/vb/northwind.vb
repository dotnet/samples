...
Partial Public Class Northwnd
  ...
  #End Region
    ...
    Public Function InsertShipperService(ByVal shpr As Shipper) As Object
        Return shpr
        ' Dim InsertShipperService As Object = New Object
    End Function
    ...
    '    IEnumerable(Of Order)
    '    LoadOrdersCalled += 1
    '    Return Me.Orders.Where(Function(o) o.ShipVia = shipper.ShipperID)
    'End Function
    ...
    '' Block 6
    'Sub InsertShipperService(ByVal shpr As Shipper)
    '    Dim InsertShipperService As Object = New Object()
    'End Sub

    '' Block 7
    ''Public Shared InsertShipperService(shpr As Shipper) as Object
    ''    Dim InsertShipperService As Object = New Object
    ''    Return 0
