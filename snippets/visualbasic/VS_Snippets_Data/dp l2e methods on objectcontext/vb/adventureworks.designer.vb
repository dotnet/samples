...
<Assembly: EdmSchemaAttribute("acfe1ab6-f28b-42e7-a211-b2e6b92e8fb6")>
...
Public Partial Class AdventureWorksEntities 
    ...
    ''' No Metadata Documentation available.
    ''' </summary>
    Public ReadOnly Property AddressTypes() As ObjectSet(Of AddressType)
        Get
            If (_AddressTypes Is Nothing) Then
                _AddressTypes = MyBase.CreateObjectSet(Of AddressType)("AddressTypes")
            End If
            Return _AddressTypes
        End Get
    End Property
    
    Private _AddressTypes As ObjectSet(Of AddressType)
    ...
    ''' <summary>
    ''' Deprecated Method for adding a new object to the AddressTypes EntitySet. Consider using the .Add method of the associated ObjectSet(Of T) property instead.
    ''' </summary>
    Public Sub AddToAddressTypes(ByVal addressType As AddressType)
        MyBase.AddObject("AddressTypes", addressType)
    End Sub
...
Public Partial Class AddressType 
    ...
    Public Shared Function CreateAddressType(addressTypeID As Global.System.Int32, name As Global.System.String, rowguid As Global.System.Guid, modifiedDate As Global.System.DateTime) As AddressType
        Dim addressType as AddressType = New AddressType
