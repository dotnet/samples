...
Namespace UE.ServiceModel.Samples
    ...
    Class Client
        ...
        Public Shared Sub Main()
            ...
            Dim url As String = "http://localhost:8000/servicemodelsamples/service/calc"
            Dim address As EndpointAddress = New EndpointAddress(url)
            ...
            Dim c As IChannel = (CType(channel, IChannel))
            c.Close()
            Console.ReadLine()
        End Sub
