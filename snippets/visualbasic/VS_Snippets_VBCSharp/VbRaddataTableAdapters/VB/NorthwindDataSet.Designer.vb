...
Namespace NorthwindDataSetTableAdapters
    ...
    Partial Public Class OrdersTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1) = New System.Data.SqlClient.SqlCommand
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT OrderID, CustomerID, EmployeeID, OrderDate, RequiredDate, ShippedDate, Shi"& _ 
                "pVia, Freight, ShipName, ShipAddress, ShipCity, ShipRegion, ShipPostalCode, Ship"& _ 
                "Country FROM dbo.Orders"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE (ShippedDate = @ShippedDate) OR"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"        (Shipped"& _ 
                "Date IS NULL)"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)
            Me._commandCollection(1).CommandType = System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New System.Data.SqlClient.SqlParameter("@ShippedDate", System.Data.SqlDbType.DateTime, 8, System.Data.ParameterDirection.Input, 0, 0, "ShippedDate", System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillByShippedDate(ByVal dataTable As NorthwindDataSet.OrdersDataTable, ByVal ShippedDate As System.Nullable(Of Date)) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
    ...
    Partial Public Class QueriesTableAdapter
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Private Sub InitCommandCollection()
            Me._commandCollection = New System.Data.IDbCommand(0) {}
            Me._commandCollection(0) = New System.Data.SqlClient.SqlCommand
            CType(Me._commandCollection(0),System.Data.SqlClient.SqlCommand).Connection = New System.Data.SqlClient.SqlConnection("Data Source=(local);Initial Catalog=Northwind;Integrated Security=True")
            CType(Me._commandCollection(0),System.Data.SqlClient.SqlCommand).CommandText = "select count(*) from customers"
            CType(Me._commandCollection(0),System.Data.SqlClient.SqlCommand).CommandType = System.Data.CommandType.Text
        End Sub
        
        <System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function CustomerCount() As System.Nullable(Of Integer)
