...
Public Class MathSvc
   ...
   System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/Add", Use := _
   System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle := _
   ...
   Public Sub New()
      Me.Url = "http://localhost/MathSvc_SoapHeaderException1.vb.asmx"
   End Sub 'New
