...
' Snippets 1 and 2 are the same, except snippet 2
' has no C# file.
' When IteratorStateMachineAttribute is implemented
' for C#, then IteratorStateMachineAttribute can use
' snippet 1 instead of snippet 2.
