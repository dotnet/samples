...
Public Class Form1
    ...
    Private Sub Button1_Click( _
        ...
        dim dataToEncrypt as String = "Sample Contoso encryption application."
        tbxOutput.AppendText("Data to encrypt : " + dataToEncrypt + vbCrLf)

        ' Create a public key for encryption/decryption efforts.
        dim rsa as RSA = RSA.Create()

        ' Encrypt the data and display the result to the console.
        dim formatter as new Contoso.ContosoFormatter(rsa)
        dim encryptedData() as byte
        encryptedData = formatter.CreateKeyExchange( _
            System.Text.Encoding.ASCII.GetBytes(dataToEncrypt))
        tbxOutput.AppendText("Encrypted data: " + _
        ...
        dim deformatter as new Contoso.ContosoDeformatter(rsa)
        dim decryptedData() as byte 
        decryptedData = deformatter.DecryptKeyExchange(encryptedData)
        tbxOutput.AppendText("Data decrypted : " + _
            System.Text.Encoding.ASCII.GetString(decryptedData) + vbCrLf)
