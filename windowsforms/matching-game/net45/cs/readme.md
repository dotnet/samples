...
- windows-forms
page_type: sample
name: "Matching Game Sample (.NET Framework)"
urlFragment: "matching-game-net45-csharp"
description: "A simple matching game "
---
# Matching game

This sample demonstrates a simple memory game where you try to match tiles in the fewest amount of moves possible. This sample was used as the basis of a migration tutorial and was migrated to [.NET 5](https://github.com/dotnet/samples/tree/master/windowsforms/matching-game/net5-windows/cs).
