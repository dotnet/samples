...
- windows
page_type: sample
name: ".NET Core Windows Forms Conways Game Of Life (Visual Basic)"
...
This Windows Forms sample was ported to .NET Core from a [previous .NET Framework 4.5 sample](https://github.com/microsoftarchive/msdn-code-gallery-community-a-c/tree/master/Conway's%20Game%20of%20Life).
